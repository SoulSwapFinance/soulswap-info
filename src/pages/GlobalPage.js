...
function GlobalPage() {
  ...
  const { liquidityUSD, oneDayVolumeUSD, volumeChangeUSD, liquidityChangeUSD } = useGlobalData()
  ...
  return (
    <PageWrapper>
      <ThemedBackground backgroundColor={transparentize(0.6, '#C800FF')} />
      <ContentWrapper>
        <div>
          <AutoColumn gap="24px" style={{ paddingBottom: below800 ? '0' : '24px' }}>
            <TYPE.largeHeader>{below800 ? 'SoulSwap Analytics' : 'SoulSwap Analytics'}</TYPE.largeHeader>
            <Search />
            <GlobalStats />
          </AutoColumn>
                ...
                <Box>
                  <AutoColumn gap="36px">
                    ...
                    <AutoColumn gap="20px">
                      ...
                      <RowBetween align="flex-end">
                        <TYPE.main fontSize={'1.5rem'} lineHeight={1} fontWeight={600}>
                          {liquidityUSD ? formattedNum(liquidityUSD, true) : '-'}
                        </TYPE.main>
